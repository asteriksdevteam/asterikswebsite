...
<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">What We Do Section</h5>
    {{-- <p class="mb-25">About Us</p> --}}
    <div class="row">
        <div class="col-sm">

            <form action="{{route('admin.wwd.update',@$wwd->id??1)}}" method="post" enctype="multipart/form-data">
                {{-- @method('put') --}}
                @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-15">
                    ...
                    <input type="text" class="form-control" value="{{ @$wwd->Name }}" name="name" placeholder=""   required>
                </div>
                 <div class="col-md-12 mt-15">
                     <label><strong>Main Heading</strong></label> 
                     <input type="text" class="form-control" value="{{ @$wwd->Heading }}" name="heading" placeholder=""   required>
                 </div>
                 <div class="col-md-12 mt-15">
                    <label><strong>Main Descriptions</strong></label>                    
                    <textarea class="form-control"  name="description" rows="3" placeholder="" required>{{ @$wwd->Description }}</textarea>
                </div>
                ...
                <div class="col-md-3 mt-15">
                    ...
                    <img src="{{asset(@$wwd->business_idea_image?? 'images/no_img.png')}}" alt="" width="150" height="80">
                </div>
                <div class="col-md-12 mt-15 text-center">  <h3>Finance Planning System</h3></div>
                 <div class="col-md-12 mt-15">
                    <label><strong>Heading</strong></label> 
                    <input type="text" class="form-control" value="{{ @$wwd->finance_planning_heading }}" name="finance_planning_heading" placeholder=""   required>
                </div>
                 <div class="col-md-12 mt-15">
                    <label><strong>Description</strong></label>                    
                    <textarea class="form-control"  name="finance_planning_desc"  rows="3" placeholder="" required>{{ @$wwd->finance_planning_desc }}</textarea>
                </div>
                <div class="col-md-9 mt-15">
                    <label class="mb-0" for=""><strong>Image</strong></label>
                ...
                <div class="col-md-3 mt-15">
                    <label class="mb-0" for=""><strong>Thumbnail</strong></label><br>
                    <img src="{{asset(@$wwd->finance_planning_image?? 'images/no_img.png')}}" alt="" width="150" height="80">
                </div>
                <div class="col-md-12 mt-15 text-center">  <h3>Development Website & App</h3></div>
                 <div class="col-md-12 mt-15">
                    <label><strong>Heading</strong></label> 
                    <input type="text" class="form-control" value="{{ @$wwd->develop_web_heading }}" name="develop_web_heading" placeholder=""   required>
                </div>
                 <div class="col-md-12 mt-15">
                    <label><strong>Description</strong></label>                    
                ...
                <div class="col-md-3 mt-15">
                    <label class="mb-0" for=""><strong>Thumbnail</strong></label><br>
                    <img src="{{asset(@$wwd->develop_web_image?? 'images/no_img.png')}}" alt="" width="150" height="80" >
                </div>
                <div class="col-md-12 mt-15 text-center">  <h3>Market Analysis Project</h3></div>
                 ...
                 <div class="col-md-12 mt-15">
                    <label><strong>Description</strong></label>                    
                    <textarea class="form-control"  name="market_analysis_desc"  rows="3" placeholder="" required>{{ @$wwd->market_analysis_desc }}</textarea>
                </div>
                <div class="col-md-9 mt-15">
                    <label class="mb-0" for=""><strong>Image</strong></label>
                ...
                <div class="col-md-3 mt-15">
                    <label class="mb-0" for=""><strong>Thumbnail</strong></label><br>
                    <img src="{{asset(@$wwd->market_analysis_image?? 'images/no_img.png')}}" alt="" width="150" height="80">
                </div>
