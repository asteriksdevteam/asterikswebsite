...
<section class="hk-sec-wrapper">
    ...
    <div class="row">
        <div class="col-sm">
            <form action="{{route('admin.award.update',$awards->id)}}" method="post" enctype="multipart/form-data">
                @csrf
            <div class="row">
                <div class="col-md-6 form-group">
                    <label class="mb-0" for="">Heading</label>
                    <input type="text" value="{{$awards->Heading}}" name="heading" class="form-control outline-input mt-15 py-1" required>
                </div>
                <div class="col-md-12 form-group">
                    <label class="mb-0" for="">Description</label>
                    <textarea class="form-control mt-15" name="description" id="description" rows="3" placeholder="Slider Description" required> {{$awards->Description}}</textarea>
                </div>
                <div class="col-md-6 form-group">
