            ...
            <section class="hk-sec-wrapper">
                <div class="row">
                    ...
                    <div class="col-sm">
                        <h4>Select Images</h4>
                        <hr>
                        <form action="{{route('admin.tech.image.store.slider',@$slider->id??1)}}" method="post" class="text-center" enctype="multipart/form-data">
                        <div class="row">
                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-15">
                                            ...
                                            <video width="320" class="mx-25" height="240" controls>
                                              ...
                                              @endif
                                                <form action="{{route('tech.image.delete.slider',$image->id)}}" method="post" class="text-center" >
                                                @csrf
