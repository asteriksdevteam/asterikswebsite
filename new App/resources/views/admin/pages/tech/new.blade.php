...
<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">Create New Technology</h5>
    <div class="row">
        <div class="col-sm">
            ...
            <div class="row">
                <div class="col-md-6 mt-15">
                    ...
                    <input type="text" value="" name="name" id="name" class="form-control outline-input mt-15" placeholder="Tech Name" required>
                </div>
                <div class="col-md-6 mt-15">
