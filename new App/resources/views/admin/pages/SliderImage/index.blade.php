    ...
    <div class="row">
        <div class="col-xl-12">
            <section class="hk-sec-wrapper">
                <a href="{{route('admin.slider.image.create')}}" class="btn btn-primary my-10 py-1">Add New+</a>
                <div class="row">
                    <div class="col-12">
                            ...
                            <table id="datable_1" class="table w-100 display pb-30">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{@$data->imageAlt}}</td>
                                        <td><a href="{{route('admin.slider.image.edit',$data->id)}}"><i class="fa fa-edit text-blue"></i></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
