...
<section class="hk-sec-wrapper">
    ...
    <div class="row">
        <div class="col-sm">
            <form action="{{route('admin.slider.image.update',$sliderImg->id)}}" method="post" enctype="multipart/form-data">
                @csrf
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" value="{{$sliderImg->imageAlt}}" name="alt" id="alt" class="form-control outline-input mt-15" placeholder="Slider Image Alt" required>
                </div>
