        ...
        <div class="col-sm">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <select name="imageid" class="form-control custom-select  mt-15" required>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="alt" id="alt" class="form-control outline-input mt-15" placeholder="Slider Image Alt" required> 
                </div>
