...
<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">Create New Banner</h5>
    <div class="row">
        <div class="col-sm">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" value="" name="name" id="name" class="form-control outline-input mt-15" placeholder="Slider Name" required>
                </div>
                <div class="col-md-6 form-group">
                    <label class="mb-0" for="">Heading</label>
                    <input type="text" value="" name="heading" id="heading" class="form-control outline-input mt-15" placeholder="Slider Heading" required>
                </div>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <div class="d-flex">
                    <input type="radio" value="1" class="mx-1" name="status" checked> Enable
