...
<section class="hk-sec-wrapper">
    ...
    <div class="row">
        <div class="col-sm">
            <form action="{{ route('admin.blog-page.update',['id'=> @$blogPage['id']??1]) }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
            ...
            <div class="row">
                <div class="col-md-12 mt-15 text-center">  <h3>Silder Content</h3></div>
                 <div class="col-md-12 mt-15">
                     ...
                     <input type="text" class="form-control" value="{{ @$blogPage['slider_heading'] }}" name="slider_heading" placeholder=""   required>
                 </div>
                <div class="col-md-12 mt-15">
                    <label><strong>Sldier Content</strong></label>                    
                    <textarea class="form-control"  name="slider_heading_content" id="exampleFormControlTextarea1" rows="3" placeholder="" required>{{ @$blogPage['slider_heading_content'] }}</textarea>
                </div>

                <div class="col-md-12 mt-15">
                     <label><strong>Upload Image</strong></label> 
                     <input type="file" class="form-control" value="{{ @$blogPage['work_image'] }}" name="work_image" placeholder=""  >
                     <img src="{{ asset('uploads/blogpage/') }}/{{ @$blogPage['work_image'] }}" class="mt-25 w-25" onerror="this.src='{{asset('images/no_img.png')}}'">
                </div>
