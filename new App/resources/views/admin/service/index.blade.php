   ...
   <div class="row">
      ...
      <div class="col-xl-12">
         <section class="hk-sec-wrapper">
            ...
            <form action="{{route('admin.get-data')}}" method="get" enctype="multipart/form-data">
               {{-- @method('put') --}}
               @csrf
               <div class="row">
                  <div class="col-sm">
               ...
               <div class="row">
                  <div class="col-sm">
                    ...
                    <div class="col-md-12 mt-15">
                           ...
                           <input type="text" class="form-control" value="{{ @$services->sub_heading_chooseservices }}" name="sub_heading_chooseservices" placeholder=""   >
                        </div>
                        <div class="col-md-12 mt-15">
                           <label><strong>Description</strong></label>                    
                        ...
                        <div class="col-md-12 mt-15">
                           <label><strong>Heading</strong></label> 
                           <input type="text" class="form-control" value="{{ @$services->process_heading }}" name="processheading" placeholder=""   >
                        </div>
                        <div class="col-md-12 mt-15">
                           <label><strong>Sub Heading</strong></label> 
                           <input type="text" class="form-control" value="{{ @$services->sub_heading_ourprocess }}" name="sub_heading_ourprocess" placeholder=""   >
                        </div>
                        <div class="col-md-12 mt-15">
                           <label><strong>Description</strong></label>                    
                           <textarea class="form-control"  name="processdesc"  rows="3" placeholder="" >{{ @$services->process_desc }}</textarea>
                        </div>
                        <div class="col-md-12 mt-15 text-center">
                           <h3>Process One</h3>
                        </div>
...
<script>
   $(document).ready(function(){
       ...
       $.ajax({
           url: "{{route('admin.get-subcategor')}}",
           type: 'GET',
