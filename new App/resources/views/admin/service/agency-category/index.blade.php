    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <section class="hk-sec-wrapper">
                <a href="{{route('admin.agency.create')}}" class="btn btn-primary my-10 py-1">Add New+</a>
                <div class="row">
                    <div class="col-sm">
                            ...
                            <table id="datable_1" class="table w-100 display pb-30">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$data->name}}</td>
                                        <td><a href="{{route('admin.agency.edit',$data->id)}}"><i class="fa fa-edit text-blue"></i></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
