...

{
...

    {
        ...
        return view('admin.pages.sliderImage.index',compact('sliderImage'));
...

    {
      ...
      return view('admin.pages.sliderImage.new',compact('slider'));
...

    {
        ...
        if ($request->hasFile('image')) {
          ...
          $file->move('public/uploads/slider/', $SliderImage);
...

    {
      ...
      return view('admin.pages.sliderImage.edit',compact('sliderImg','slider'));
...

    {
      ...
      return redirect()->route('admin.slider.image.index')->with('success', 'Successfully Updated');
