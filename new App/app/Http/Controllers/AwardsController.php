...

{
...

    {
      ...
      if ($request->hasFile('image')) {
        ...
        $file->move('public/uploads/awards/', $SliderImage);
...

    {
      ...
      return view('admin.pages.awards.edit',compact('awards'));
...

    {
      ...
      return redirect()->route('admin.award.index')->with('success', 'Successfully Updated');
