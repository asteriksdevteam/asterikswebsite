...

{
...

    {
      ...
      $isService = false;
        ...
        return view('admin.service.index',compact('isService','categories','subcategories'));
    ...
    public function getData(Request $request) {
      ...
      return view('admin.service.index',compact('isService','services','cateId','subcateId','categories','subcategories'));
...

    {
        ...
        if ($request->hasFile('header_image')) {
          ...
          $file->move('public/uploads/service/', $header_image);
        ...
        if ($request->hasFile('box1image')) {
          ...
          $file->move('public/uploads/service/', $box1image);
        ...
        if ($request->hasFile('box2image')) {
          ...
          $file->move('public/uploads/service/', $box2image);
        ...
        if ($request->hasFile('box3image')) {
          ...
          $file->move('public/uploads/service/', $box3image);
        ...
        if ($request->hasFile('box4image')) {
          ...
          $file->move('public/uploads/service/', $box4image);
        ...
        if ($request->hasFile('portfolioimage')) {
          ...
          $file->move('public/uploads/service/', $portfolioimage);
        ...
        if ($request->hasFile('portfoliologo')) {
          ...
          $file->move('public/uploads/service/', $portfoliologo);
        ...
        if ($request->hasFile('chooseimage')) {
          ...
          $file->move('public/uploads/service/', $chooseimage);
        ...
        if ($request->hasFile('tab1image')) {
          ...
          $file->move('public/uploads/service/', $tab1_image);
        ...
        if ($request->hasFile('tab2image')) {
          ...
          $file->move('public/uploads/service/', $tab2_image);
        ...
        if ($request->hasFile('tab3image')) {
          ...
          $file->move('public/uploads/service/', $tab3_image);
        ...
        if ($request->hasFile('tab4image')) {
          ...
          $file->move('public/uploads/service/', $tab4_image);
        ...
        if ($request->hasFile('tab5image')) {
          ...
          $file->move('public/uploads/service/', $tab5_image);
      ...
      $service->company_desc = @$request->fcompanydesc;
      ...
      $service->sub_heading_chooseservices = @$request->sub_heading_chooseservices;
      $service->sub_heading_ourprocess = @$request->sub_heading_ourprocess;
      $service->agency_desc = @$request->agencydesc;
      $service->agency_heading = @$request->agencyheading;
      $service->save();
