...
$config['licenseName'] = 'http://admin.direvhotel.com';
$config['licenseKey']  = 'absdzxcwse123';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://www.image.direvhotel.com/'.$_COOKIE['accid'].'/',
	'root'         => '/home/direvhotel/public_html/cms/uploads/'.$_COOKIE['accid'].'/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
