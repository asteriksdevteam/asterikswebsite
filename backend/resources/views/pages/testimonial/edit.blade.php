        ...
        <div class="col-sm">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" value="{{$testimonial->Name}}" name="name" class="form-control outline-input mt-15 py-1">
                </div>
                {{-- <div class="col-md-6 form-group">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea class="form-control mt-15" name="message" id="description" rows="3" placeholder="Slider Description">{{$testimonial->Message}}</textarea>
                </div>
                <div class="col-md-6 form-group">
