...
<section class="hk-sec-wrapper">
    ...
    <div class="row">
        <div class="col-sm">
            <form action="{{ route('career.update',['id'=> @$career['id']]) }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
            ...
            <div class="row">
                <div class="col-md-12 mt-15 text-center">  <h3>Silder Content</h3></div>
                 <div class="col-md-12 mt-15">
                     ...
                     <input type="text" class="form-control" value="{{ $career['slider_heading'] }}" name="slider_heading" placeholder=""   >
                 </div>
                <div class="col-md-12 mt-15">
                    <label><strong>Sldier Content</strong></label>                    
                    <textarea class="form-control"  name="slider_heading_content" id="exampleFormControlTextarea1" rows="3" placeholder="" >{{ $career['slider_heading_content'] }}</textarea>
                </div>
               ...
               <div class="col-md-12 mt-15 text-center"> <h3>Our Recruitment Process</h3></div>
                ...
                <div class="col-md-12 mt-15">
                    ...
                    <textarea class="form-control " name="apply" id="exampleFormControlTextarea1" rows="3" placeholder="" >{{ $career['apply'] }}</textarea>
                </div>
                <div class="col-md-12 mt-15">
                    <label><strong>Review</strong></label>                    
                    <textarea class="form-control " name="review" id="exampleFormControlTextarea1" rows="3" placeholder="" >{{ $career['review'] }}</textarea>
                </div>
                <div class="col-md-12 mt-15">
                ...
                <div class="col-md-12 mt-15">
                    ...
                    <textarea class="form-control " name="onboarding" id="exampleFormControlTextarea1" rows="3" placeholder="" >{{ $career['onboarding'] }}</textarea>
                </div>
