...
class AgencyCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('service.agency-category.index',compact('agency'));
    }
    public function create(){
      $categories = SubCategory::all();
      return view('service.agency-category.create',compact('categories'));
    }
    ...
    public function edit($id)
    {
      ...
      $categories = SubCategory::all();
      return view('service.agency-category.edit',compact('agency','categories'));
    }
