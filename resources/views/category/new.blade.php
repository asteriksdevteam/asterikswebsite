    ...
    <div class="row">
        <div class="col-xl-12">
            <section class="hk-sec-wrapper">
                ...
                <div class="row">
                    <div class="col-sm">
                        <form action="{{ @$categories? route('category.update',['id'=>@$categories->id]) :  route('category.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                @if(@$categories)
                                 @method('put')
                              @endif
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="file" name="image" class="form-control outline-input mt-15 py-1">
                                 @if(@$categories)
                                <img class="w-25 mt-15" src="{{ asset('uploads/category') }}/{{ $categories->category_image }}">
                                @endif
                            </div>
                            <div class="col-md-12 form-group">
