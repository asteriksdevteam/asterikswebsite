    ...
    <div class="row">
        <div class="col-xl-12">
            <section class="hk-sec-wrapper">
                ...
                <div class="row">
                    <div class="col-sm">
                        <form action="{{ @$subcategories? route('service.subcategory.update',['id'=>@$subcategories->id]) :  route('service.subcategory.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                @if(@$subcategories)
                                 @method('put')
                              @endif
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control outline-input mt-15" value="{{ @$subcategories->name }}" placeholder="Category Name">
                            </div>
