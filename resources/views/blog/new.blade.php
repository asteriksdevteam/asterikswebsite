        ...
        <div class="col-xl-12">
            <section class="hk-sec-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <form method="post" action="{{@$blog ? route('blog.update',['id'=>$blog->id] ) : route('blog.store') }}" class="" enctype="multipart/form-data">
                        @csrf
                        @if(@$blog)
                            @method('put')
                        @endif
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        @if(@$blog)
                                            <img src="{{ asset($blog->thumb) }}" width="100">
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="w-100 form-control ckeditor" id="ckeditor" rows="10" cols="20" name="short_description" placeholder="Enter blog short_description">{{ old('short_description') ? old('short_description') : @$blog->short_description }}</textarea>
