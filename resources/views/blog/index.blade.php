    ...
    <div class="row">
        <div class="col-xl-12">
            <section class="hk-sec-wrapper">
                <a href="{{route('blog.create')}}" class="btn btn-primary my-10 py-1">Add New+</a>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="table-wrap">
                            <table class="table table-striped- table-bordered table-hover table-checkable" id="data-table">
                                ...
                                @foreach($blogs as $blog)
                                    <tr>
                                        <td>{{$blog->name}}</td>
                                        <td><img src="{{ asset('uploads/blog/thumb') }}/{{ $blog->image }}" width="30"></td>
                                        <td>{{$blog->status==1 ?'enable' : 'disable'}}</td>
                                        <td><a href="{{route('blog.edit',
                                        ['id'=>$blog->id])}}">Edit</a> / 
