...
class ContactUsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('contactus.new',compact('contactus'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('slider_image')) {
          ...
          $file->move('uploads/contactus/', $SliderImage);
        }else
        {
        ...
        if ($request->hasFile('work_with_image_1')) {
          ...
          $file->move('uploads/contactus/',  $work_with_image_1);
        }else
        {
          $contactUs =   ContactUs::find($request->id);
        ...
        if ($request->hasFile('work_with_image_2')) {
          ...
          $file->move('uploads/contactus/', $work_with_image_2);
        }else
        {
          $contactUs =   ContactUs::find($request->id);
